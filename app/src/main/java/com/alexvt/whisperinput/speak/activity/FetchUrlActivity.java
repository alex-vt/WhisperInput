...
public class FetchUrlActivity extends AppCompatActivity {
    ...
    public static final String EXTRA_HTTP_METHOD = "com.alexvt.whisperinput.extra.HTTP_METHOD";
    public static final String EXTRA_HTTP_BODY = "com.alexvt.whisperinput.extra.HTTP_BODY";
    public static final String EXTRA_HTTP_HEADER = "com.alexvt.whisperinput.extra.HTTP_HEADER";
