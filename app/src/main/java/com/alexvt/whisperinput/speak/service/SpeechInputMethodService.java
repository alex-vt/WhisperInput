...
import com.alexvt.whisperinput.speak.activity.PermissionsRequesterActivity;
...
import com.alexvt.whisperinput.speak.view.AbstractSpeechInputViewListener;
import com.alexvt.whisperinput.speak.view.SpeechInputView;
...
public class SpeechInputMethodService extends InputMethodService {
    ...
    public void onStartInputView(EditorInfo editorInfo, boolean restarting) {
        ...
        if (true) { // todo PreferenceUtils.getPrefBoolean(mPrefs, mRes, R.string.keyImeAutoStart, R.bool.defaultImeAutoStart)) {
            Log.i("Auto-starting");
            mInputView.start();
        }
    }
