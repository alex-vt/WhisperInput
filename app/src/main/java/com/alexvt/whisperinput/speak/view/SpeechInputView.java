package com.alexvt.whisperinput.speak.view;
...
import com.alexvt.whisperinput.speak.OnSwipeTouchListener;
import com.alexvt.whisperinput.speak.PackageNameRegistry;
import com.alexvt.whisperinput.R;
import com.alexvt.whisperinput.speak.activity.RewritesActivity;
import com.alexvt.whisperinput.speak.activity.RewritesSelectorActivity;
import com.alexvt.whisperinput.speak.adapter.ClipboardAdapter;
import com.alexvt.whisperinput.speak.model.CallerInfo;
...
public class SpeechInputView extends LinearLayoutCompat {
    ...
    public void init(int keys, CallerInfo callerInfo, boolean swipeType, ComponentName app) {
        ...
        if (swipeType) {
            ...
            // todo key buttons management findViewById(R.id.rlKeyButtons).setVisibility(View.VISIBLE);
        }
    ...
    */
    ...
    private void setGuiInitState(int message) {
        if (message == 0) {
            ...
            // todo key buttons management setVisibility(findViewById(R.id.rlKeyButtons), View.VISIBLE);
        } else {
    ...
    private class SpeechInputRecognitionListener implements RecognitionListener {
        ...
        public void onBeginningOfSpeech() {
            ...
            mBtnType = "R";
            // todo key buttons management setVisibility(findViewById(R.id.rlKeyButtons), View.INVISIBLE);
        }
